...
func TestForm_Has(t *testing.T){
	...
	if !has {
		t.Error("shows form does not have field whent it should have")
	}
}
...
func TestForm_MinLength(t *testing.T) {
	...
	if form.Valid() {
		t.Error("shows min length of 100 met when data is shoretr")
	}
...
func TestForm_IsEmail(t *testing.T) {
	...
	if !form.Valid() {
		t.Error("got an invalid email when we should not hvae")
	}
