...
import (
	...
	"github.com/kasuki2/bookings/internal/forms"
	"net/http"
	"fmt"
	"encoding/json"
	"log"
...
func (m *Repository) PostReservation(w http.ResponseWriter, r *http.Request){
	...
	if !form.Valid() {
		data := make(map[string]interface{})
		// megvannak az adatiok, amit a user beadott a form-on
	...
	// pass reservation data to reservation summary page
	// you can do it through session
